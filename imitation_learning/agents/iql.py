...
class IQLAgent(flax.struct.PyTreeNode):
    ...
    def value_loss(self, batch, grad_params):
        ...
        target_q = self.network.select("target_critic")(batch["observations"], batch["actions"])
    ...
    def critic_loss(self, batch, grad_params):
        ...
        q = self.network.select("critic")(batch["observations"], batch["actions"])
        target_v = self.network.select("value")(batch["observations"], params= grad_params)
    ...
    def create(cls, seed, ex_observations, ex_actions, cfg):
        ...
        _cfg = copy.deepcopy(IQL_CONFIG_DICT)
        ...
        network_info = dict(
            ...
            target_critic=(target_critic_def, (ex_observations, ex_actions))
        )
