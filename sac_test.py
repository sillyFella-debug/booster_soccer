...
def resolve_model_filename(env_id: str) -> str:
    ...
    if "kick" in env_lc:
        ...
        return "/media/deter/New Volume/Neamur/codes/booster_soccer_showdown/sac_models/sac_model_240000_steps.zip"
    raise ValueError(
...
def main():
    ...
    try:
        ...
        #     repo_type="model",
        # )
        model_file = model_relpath  # Local path for testing
